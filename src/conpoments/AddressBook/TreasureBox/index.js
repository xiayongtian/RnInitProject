          ...
          <ScrollView>
            <View style={{ flex: 1 }}>
              <ImageBackground source={require('../../../assets/bg.jpg')} imageStyle={{ borderRadius: 5 }} style={styles.bg}>
                ...
                {/* 最近访问 */}
                <View style={styles.recenVisit}>
                  <View>
                    <Text style={styles.recentVisitTitle}>最近访问</Text>
                  </View>
                  <View style={styles.item}>
                    {baiRecentVisit && baiRecentVisit.body.map(item => {
              ...
              <View style={styles.recenVisit}>
                <View>
                  <Text style={styles.recentVisitTitle}>高效工作</Text>
                </View>
                <View style={styles.item}>
              ...
              <View style={styles.recenVisit}>
                <View>
                  <Text style={styles.recentVisitTitle}>企业生活</Text>
                </View>
                <View style={styles.item}>
              ...
              <View style={styles.recenVisit}>
                <View>
                  <Text style={styles.recentVisitTitle}>实验室</Text>
                </View>
                <View style={styles.item}>
...
const styles = StyleSheet.create({
  ...
  recentVisitTitle: { fontSize: 20, color: '#120f25', paddingLeft: 20, fontWeight: 'bold', paddingBottom: 5 },
